...
var ExperienceTimeline = function($rootScope, $document, $timeout, $scope) {
	...
	$scope.events = [{
		...
		title: 'Daitan Group',
		titleContentHtml: '<h3>Full Stack Developer</h3><img class="timeline-img" src="images/daitan.png"></img>',
		...
		titleContentHtml: '<h3>Chief Executive Officer </h3><img class="timeline-img" src="images/obelisco.png"></img>',
		...
		titleContentHtml: '<h3>Full Stack Developer Intern</h3> <img class="timeline-img" src="images/tcd.png"></img>',
		...
		titleContentHtml: '<h3>Intern Test Engineer</h3><img class="timeline-img" src="images/dell.png"></img>',
		...
		titleContentHtml: '<h3>Teaching Assistant</h3><img class="timeline-img" src="images/ifsp.png"></img>',
		...
		titleContentHtml: '<h3>Volunteer Researcher</h3><img class="timeline-img" src="images/cti.png"></img>',
